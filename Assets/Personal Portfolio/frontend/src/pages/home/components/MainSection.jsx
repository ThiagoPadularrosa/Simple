import webimg from '../../../assets/images/web.webp'
...
const cardsSkills = [
  {
    ...
    image: webimg, // At the hour of import a varible with the img, it should be used as a no-string, because if i use strings it will not be possible to show the img
  },
  {
